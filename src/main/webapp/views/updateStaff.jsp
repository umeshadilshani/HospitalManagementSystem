...
<!-- Navigation Bar -->
		...
		<div class="container-fluid" style="background-color: rgb(248, 249, 250);">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent" >
				<ul class="navbar-nav mx-auto">
					<li class="nav-item">
						<a class="nav-link" href="viewStaff.jsp">View</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="addStaff.jsp">Add</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="#">Update</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="deleteStaff.jsp">Delete</a>
					</li>
				</ul>
			</div>
	...
	<h1 style="font-family: Courgette; text-align: center; color: #0077b6;">Update
		Staff Details</h1>

	<div class="container mt-5" style="margin-top: 50px;" id="id1">
		<!-- Check employee details -->
		<form action="CheckEmp" method="post"
		...
		<!-- Status related to the employee id check -->
		<%
		...
		<hr>
		<form class="row" action="UpdateEmp" method="post"
			novalidate="novalidate" id="updateEmp">
			<%
			if (request.getAttribute("update") == null) {
			%>
			<div></div>
			<%
			} else if ((Integer) request.getAttribute("update") == 0) {
			%>
			<div class="alert alert-success" role="alert" id="message"
				style="margin-top: 10px;">
				<button type="button" class="btn-close" data-bs-dismiss="alert"
			...
			<div class="col-md-6">
				<label for="nic" class="form-label">NIC</label> <input type="text"
					...
					<%if (request.getAttribute("nic") == null) {%> value=""
			...
			<div class="col-md-6">
				<label for="phone" class="form-label">Contact</label> <input
					...
					<%if (request.getAttribute("contact") == null) {%> value=""
					<%} else {%>
			...
			<div class="col-md-6">
				...
				<textarea class="form-control" rows="5" cols="20" name="address">
					<%
