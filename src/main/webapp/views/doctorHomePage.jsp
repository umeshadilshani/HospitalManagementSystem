<%@page import="model.Cards"%>
<%@page import="service.CardDBUtil"%>
...
<!-- Styles for error messages -->
		...
		<div class="container-fluid" style="background-color: rgb(248, 249, 250);">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent" >
				<ul class="navbar-nav mx-auto">
					<li class="nav-item">
						<a class="nav-link" href="doctorHomePage.jsp">Patient Cards</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="addCard.jsp">Add</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="updateCard.jsp">Update</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="deleteCard.jsp">Delete</a>
					</li>
				</ul>
			</div>
    ...
    <!-- Display cards -->
    <h3 style="text-align: center; color: blue;">Card Details</h3>
	<div class="stock container-lg" style="margin-bottom: 80px;">
		<div>
			<%
				CardDBUtil cardDBUtil = new CardDBUtil();
				ArrayList<Cards> cardList = cardDBUtil.getAllCards();
			...
			%>
				<div class="container-fluid" style="margin-top: 50px;">
					<table class="table">
						...
						%>
							<tr>
								<th scope="row"><%=cardList.get(i).getId()%></th>
								<td><%=cardList.get(i).getName()%></td>
								<td><%=cardList.get(i).getAge() %></td>
								<td><%=cardList.get(i).getDiagnosis() %></td>
							</tr>
						<%
						}
						%>
