...
<body style="margin-top: 100px;">
	...
	<nav class="navbar fixed-top navbar-expand-lg"
		...
		<div class="container-fluid"
			...
			<button type="button" class="btn btn-primary my-0"
				onclick="location.href='login.jsp'">Home</button>
		</div>
	</nav>
	...
	<!-- Form to add System Admin -->
	<div class="container mt-5">
		<form class="row" action="AddSysAdmin" method="post" id="addEmployee"
			...
			<div class="col-md-6">
				<label for="occupation" class="form-label">Occupation</label> <input
					...
					value="System Admin" readonly="readonly">
			</div>
			<div class="col-md-6">
