...
<html>
    <head>
        <title>Hope</title>
        <style><%@include file="../css/updateReport.css"%></style>
        <script><%@include file="../js/updateReport.js"%></script>
    </head>
    <body>
    <% int id = Integer.parseInt(request.getParameter("val"));%>
        <div class="form-container">
            <form name="formContact" method="post" action="UpdateReport" onsubmit="return validateForm()">
            <h1>Update report</h1>
                <table class="one">
                        <tr>
                            <td>
                                <div class="input-row">
                                <label >Report ID</label> <br><input type="text" class="input-field" name="R_id" value="<%=id%>" readonly="readonly">
                                </div>
                            </td>
                        </tr> 
                        ...
                        <tr>
                            <td>
                                <div class="input-row">
                                <label >Name</label> <br><input type="text" class="input-field" placeholder = "Patient's full name" name="patient_name" value ="">
                                </div>
                            </td>
                        
                            <td>
                                <div class="input-row">
                                <label >Email</label><br> <input type="text" class="input-field" class="input-field" name="email" value ="">
                                </div>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <div class="input-row">
                                <label >Gender</label> <br><input type="text" class="input-field" name="Gender" value ="">
                                </div>
                            </td>
                    
                            <td>
                                <div class="input-row">
                                <label >Age</label><br> <input type="text" class="input-field" name="Age" value ="">
                                </div>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <div class="input-row">
                                <label >Test Conductor</label><br> <input type="text" class="input-field" name="Test_conductor" value ="">
                                </div>
                            </td>
                        </tr>
                        <tr>
                ...
                <table class="two">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="input-field" name="Hemoglobin_R" value ="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" class="input-field" name="WBC_R" value ="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" class="input-field" name="RBC_R" value ="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" class="input-field" name="MCV_R" value ="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" class="input-field" name="BloodSugar_R" value ="">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" class="input-field" name="Cholesterol_R" value ="">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="4">
                    ...
                    <tr>
                        <td colspan="4">
                            <br> <br><input type="submit" name="send" class="btn-submit" value="Update" onclick=/>
                        </td>
                    </tr>
